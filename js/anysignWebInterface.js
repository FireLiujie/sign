...
document.write(
  '<link media="screen and (min-width: 480px) and (max-width: 1024px)" href="css/mw480Portrait.css" rel="stylesheet">'
);
document.write(
...
document.write(
  '<script language=javascript src="libs/CryptoJS v3.1.2/rollups/sha1.js" charset="utf-8"></script>'
);
document.write(
  '<script language=javascript src="libs/CryptoJS v3.1.2/rollups/tripledes.js" charset="utf-8"></script>'
);
document.write(
  '<script language=javascript src="libs/CryptoJS v3.1.2/components/mode-ecb.js" charset="utf-8"></script>'
);
document.write(
  '<script language=javascript src="libs/anysign_all.min.js" charset="utf-8"></script>'
);
document.write(
  '<script language=javascript src="libs/anysignCommentUI.js" charset="utf-8"></script>'
);
document.write(
  '<script language=javascript src="libs/jquery-3.4.1.min.js" charset="utf-8"></script>'
);
var core;
function AnySignApi() {
  //constants
...
function SignatureConfig(signer, signRule) {
  ...
  if (
    !(signRule instanceof SignRule_KeyWord) &&
    !(signRule instanceof SignRule_Tid) &&
    !(signRule instanceof SignRule_XYZ) &&
    !(signRule instanceof SignRule_KeyWordV2) &&
    !(signRule instanceof SignRule_KeyWordV3)
  ) {
...
var SignRule_KeyWord = function(
  ...
  if (
    keyWordAlignMethod !== 1 &&
    keyWordAlignMethod !== 2 &&
    keyWordAlignMethod !== 3 &&
    keyWordAlignMethod != 4
  ) {
